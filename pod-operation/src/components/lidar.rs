...
impl LIDARLite_v3 {
    ...
    fn i2c_write(&mut self, reg_addr: u8, data_bytes: &[u8], lidarlite_address: u16) -> Result<(), Error> {
    ...
    fn i2c_read(&mut self, reg_addr: u8, data_bytes: &mut [u8], lidarlite_address: u16) -> Result<(), Error> {
        self.i2c.write_read(lidarlite_address, &[reg_addr], data_bytes)?;
        Ok(())
    }
